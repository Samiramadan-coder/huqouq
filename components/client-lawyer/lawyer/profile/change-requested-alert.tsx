...
export async function ChangesRequestedAlert({ count }: { count: number }) {
  ...
  return (
    <div className="flex items-center justify-between gap-6 rounded-md border border-amber-300/50 bg-white px-5 py-6 mb-7">
      ...
      <Button
        variant="outline"
        className="shrink-0 bg-white font-normal border-amber-400 text-amber-700 hover:bg-amber-50 hover:text-amber-800 h-9.5"
      >
        {t("viewFeedback")}
